...
let guestNames: String[] = ["Sana", "Rameen", "Farah", "Shahzaib", "Manahel", "Reema"];
guestNames.map((items)=>
        console.log(`I want to inform you ${items} that i have found a bigger table so, i am thinking to invite three more guests`)
);
//• Add one new guest to the beginning of your array.
let firstGuest : String = "Musa";
